...
class ZonaCest
{
    ...
    public function testIndex()
    {
        ...
        $this->assertContains('Zonas de', $response); // Check if the title is present
    }
    ...
    public function testCreateZone()
    {
        ...
        $this->assertContains('Zona criada com sucesso.', $response); // Check for success message
        $this->assertContains('New Test Zone', $response); // Check if the new zone is listed
    }
    ...
    public function testUpdateZone()
    {
        ...
        $this->assertContains('Zona atualizada com sucesso!', $response); // Check for success message
        $this->assertContains('Updated Test Zone', $response); // Check if the updated zone is listed
    }
