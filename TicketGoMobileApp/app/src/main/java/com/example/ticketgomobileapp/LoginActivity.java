...
public class LoginActivity extends AppCompatActivity {
    ...
    private static final String LOGIN_URL = "http://10.0.2.2/TicketGo/backend/web/api/auth/login"; // Use o IP correto
    ...
    private void authenticateUser (String username, String password) {
        ...
        //Guardar o username nas sharedpreferences junto com o token e fazer pesquisa com o username em vez do id
